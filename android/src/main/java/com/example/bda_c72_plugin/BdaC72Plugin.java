...
public class BdaC72Plugin implements FlutterPlugin, MethodCallHandler {
 private static final String CHANNEL_IsStarted = "isStarted";
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "bda_c72_plugin");
  ...
  private void handleMethods(MethodCall call, Result result) {
    switch (call.method) {
      ...
      case CHANNEL_SETWORKAREA:
        ...
        break;
      case CHANNEL_GetDeviceModel:
        result.success(UHFHelper.getInstance().getDeviceModel());
        break;
      case CHANNEL_GetPlatform:
        result.success(UHFHelper.getInstance().getPlatform());
        break;
      default:
